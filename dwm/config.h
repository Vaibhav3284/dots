...
#if BAR_PANGO_PATCH
static const char font[]                 = "xos4 Terminus 10";
#else
...
static char selbordercolor[]             = "#cfcfcf";
static char selfloatcolor[]              = "#cfcfcf";
...
static char titleselbordercolor[]        = "#cfcfcf";
static char titleselfloatcolor[]         = "#cfcfcf";
...
static char tagsselbordercolor[]         = "#cfcfcf";
static char tagsselfloatcolor[]          = "#cfcfcf";
...
static const char col_cyan[] = "#cfcfcf";
...
static char *colors[][ColCount] = {
	...
	[SchemeHidSel]       = { hidselfgcolor,    col_gray1,    c000000,              c000000 },
	[SchemeUrg]          = { urgfgcolor,       col_gray1,       urgbordercolor,       urgfloatcolor }, 
	#if BAR_LTSYMBOL_SCHEME_PATCH
...
/* Screenshot commands */
/* Full screen -> saves to Pictures folder AND copies to clipboard */
static const char *screenshot_full[] = {
    "sh", "-c",
    "maim ~/Pictures/$(date +%Y-%m-%d_%H-%M-%S).png | xclip -selection "
    "clipboard -t image/png",
    NULL};

/* Select region -> saves to Pictures folder AND copies to clipboard */
static const char *screenshot_select[] = {
    "sh", "-c",
    "maim -s ~/Pictures/$(date +%Y-%m-%d_%H-%M-%S).png | xclip -selection "
    "clipboard -t image/png",
    NULL};
